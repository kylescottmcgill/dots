...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm, xK_grave),      runOrRaisePrompt mySP)
    ...
    -- Launch browser
    , ((modm,                 xK_b),      runOrRaise "chrome" (className =? "chrome"))
...
--
myLayout = avoidStruts $ Grid ||| full ||| tiled ||| Mirror tiled ||| ThreeColMid 1 (3/100) (1/2) ||| Circle
  where
